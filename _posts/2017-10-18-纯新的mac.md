...
4. 系统设置: 
   ...
   2. 调整trackpad. 很多手势没打开, 其实这个不是问题, 而是很多明明打开的手势, 会不起作用, 你看一眼, 啥都不做就好了. 她就在哪里, 需要等你看一眼, 苹果这么神经了.
   3. safari 设置为每次打开, 都自动打开之前打开的tab.
   4. 关掉自动首字母大写
   5. 默认spotlight搜索本目录, finder设置.
...
10. 纯新安装很省心
   ...
   6. itune 铃声 录音?
   7. photos.
   8. quick look, so far so good, 目前没有遇到之前遇到的各种神奇问题, md啥的都正常, 这个世界真神奇.
